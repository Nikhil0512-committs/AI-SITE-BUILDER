...
const Sidebar = ({isMenuOpen, project, setProject, isGenerating, setIsGenerating} : SidebarProps) => {
  ...
  return (
    <div className= {`h-full rounded-xl sm:max-w-sm bg-gray-900 border-gray-800 transition-all ${isMenuOpen ? 'max-sm:w-0 overflow-hidden' : 'w-full'}`}>
        <div className='flex flex-col h-full'>
            {/*Message Container*/}
            <div className='flex-1 overflow-y-auto no-scrollbar px-3 flex flex-col gao-4'>
