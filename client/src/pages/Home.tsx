...
import FramerImage from '../assets/Framer_Logo_Dark-Mode_Core.png'
  ...
  return (
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <form onSubmit={onSubmitHandler} className="bg-white/10 max-w-2xl w-full rounded-xl p-4 mt-10 border border-indigo-600/70 focus-within:ring-2 ring-indigo-500 transition-all">
          <textarea onChange={e => setInput(e.target.value)} className="bg-transparent outline-none text-gray-300 resize-none w-full" rows={4} placeholder="Describe your website idea in details" required />
        ...
        <div className="flex flex-wrap items-center justify-center gap-16 md:gap-20 mx-auto mt-16 ">
          <img className="max-w-28 md:max-w-32" src={FramerImage} alt="" />
          <img className="max-w-28 md:max-w-32" src={HuaweiImage} alt="" />
          <img className="max-w-28 md:max-w-32" src={InstaLogo} alt="" />
          <img className="max-w-28 md:max-w-32" src={Microsoft} alt="" />
